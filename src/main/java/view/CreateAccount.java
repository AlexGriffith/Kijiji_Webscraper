...
public class CreateAccount extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(displayName.equals("") || aLogic.getAccountWithDisplayName(displayName)!=null){
            errorMessage = "Display Name "+displayName+" already exists, or is blank.";
        }else if(username.equals("") || aLogic.getAccountWIthUser(username)!=null){
            errorMessage = "Username "+username+" already exists, or is blank.";
