...
/**
 * A form to input new Categories into the database. 
 * Used for adding categories to scrape from Kijiji. 
 * @author griff
 */
...
public class CreateCategory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(title.equals("") || cLogic.getWithTitle(title)!=null){
            errorMessage = "Title "+title+" already exists, or is blank.";
        }else if(url.equals("") || cLogic.getWithUrl(url)!=null){
